...
const styles = StyleSheet.create({
  ...
  title: { color: colors.onSurfaceTertiary, fontSize: 11, letterSpacing: 2, fontWeight: '700' },
  rwyRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  stepBtn: { width: 28, height: 28, borderRadius: 14, backgroundColor: colors.surfaceTertiary, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.border },
  rwyInputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surfaceTertiary, borderRadius: radius.md, paddingHorizontal: spacing.sm, borderWidth: 1, borderColor: colors.border },
  rwyPrefix: { color: colors.onSurfaceSecondary, fontSize: 11, fontWeight: '700', letterSpacing: 1 },
  rwyInput: {
    color: colors.brand,
    fontSize: 18,
    fontWeight: '800',
